...
for i=1:length(AN_ratio)
    Q0max = AN_ratio(i)*Qtotal(k);
    Qmax = (1-AN_ratio(i))*Qtotal(k);
...
RS_sum_cls1(k,i) = RSsum(:,1); % Rate of cluster 1
RS_1_cls1(k,i) = RS1(:,1);
RS_2_cls1(k,i) = RS2(:,1);
RS_sum_cls1_aprx(k,i) = RSsum_aprx(:,1);
RS_1_cls1_aprx(k,i) = RS1_aprx(:,1);
RS_2_cls1_aprx(k,i) = RS2_aprx(:,1);
